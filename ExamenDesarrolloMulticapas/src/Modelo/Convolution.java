...
public class Convolution {
     ...
     */
    private static double singlePixelConvolution(double[][] input,
                                                int x, int y,
                                                double[][] k,
                                                int kernelWidth,
                                                int kernelHeight) {
     ...
     */
    private static double[][] convolution2D(double[][] input,
     ...
     * @return the 2D array representing the new image
     */
    private static double[][] convolution2DPadded(double[][] input,
                                                 int width, int height,
                                                 double[][] kernel,
                                                 int kernelWidth,
                                                 int kernelHeight) {
     ...
     * @return the 2D array representing the new image
     */
    double[][] convolutionType2(double[][] input,
                                       int width, int height,
                                       double[][] kernel,
